<?php
/*
Plugin Name: Permalink modifier
Plugin URI: http://www.hardikmeckwan.com
Description: Provides the functionality to customise the global page permalink structure, allowing the addition of prefixes or file extensions to page urls e.g. <em>/page/about-us.php</em>, /my-page.html etc..., It also allows you to specify a full custom permalink on an <em>individual post or page</em> basis.
Version: 1.0
Author: Hardik Meckwan
Author URI: http://www.hardikmeckwan.com
License: GPL2
*/
...
class Permalink_Editor
{
	 ...
	 * @var string
	 */
	var $dir_name = 'Permalink-Modifier';
